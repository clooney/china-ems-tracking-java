public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// String	urlStr =null;
			// String requestData="[{\"tracking_number\": \"LY589648455CN\",\"carrier_code\":\"china-ems\",\"title\":\"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"destination_code\":\"US\",\"tracking_ship_date\":\"20180908\",\"tracking_postal_code\":\"12201\",\"lang\":\"en\",\"logistics_channel\":\"API TEST\"},{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"china-post\",\"title\":\"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"destination_code\":\"US\",\"tracking_ship_date\":\"20180908\",\"tracking_postal_code\":\"12201\",\"lang\":\"en\",\"logistics_channel\":\"API TEST\"}]";
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"batch");
			// System.out.println("result======="+result);
			
			// 7 Update Tracking item
			// String	urlStr ="/china-ems/LY589648455CN";
			...
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"LY589648455CN\",\"carrier_code\":\"china-ems\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"realtime");
			// System.out.println("result======="+result);

			// 10 Modify courier code
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"LY589648455CN\",\"carrier_code\":\"china-ems\",\"update_carrier_code\":\"china-post\"}";
			...
			// String	urlStr =null;
			// String requestData= "[{\"tracking_number\":\"LY589648455CN\",\"carrier_code\":\"china-ems\"},{\"tracking_number\":\"RP325552475CN\",\"carrier_code\":\"china-post\"}]";
			...
			// String	urlStr =null;
			// String requestData= "[{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-post\",\"destination\":\"US\",\"original\":\"CN\"}]";
			...
			// String	urlStr =null;
			// String requestData="[{\"tracking_number\":\"LY589648455CN\",\"carrier_code\":\"china-ems\",\"title\": \"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"logistics_channel\":\"API TEST\",\"destination_code\":\"US\",\"status\":\"7\"},{\"tracking_number\":\"RP325552475CN\",\"carrier_code\":\"china-post\",\"title\": \"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"logistics_channel\":\"API TEST\",\"destination_code\":\"US\",\"status\":\"7\"}]";
